...
import type { PromptData, PromptInput, PromptSource, ResolvedPromptData } from '@/components/recipes/prompt-transparency/types'
  ...
  return (
    <AlertDialog open={open} onOpenChange={handleOpenChange}>
      ...
      <AlertDialogContent className="max-w-2xl max-h-[80vh] overflow-hidden flex flex-col">
        <AlertDialogHeader>
          <AlertDialogTitle>{label} Prompt</AlertDialogTitle>
          {description ? (
